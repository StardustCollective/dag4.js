...
import { blockExplorerApi, globalDagNetwork, loadBalancerApi } from '@stardust-collective/dag4-network';
...
export class DagMonitor {
    ...
    getMemPoolFromMonitor(address) {
        ...
        const txs = this.cacheUtils.get(`network-${globalDagNetwork.getNetwork().id}-mempool`) || [];
