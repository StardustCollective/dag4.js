...
class TransactionV2 {
    ...
    constructor({ fromAddress, toAddress, amount, fee, lastTxRef, salt }) {
        ...
        if (salt === undefined) {
            salt = BigInt(MIN_SALT + parseInt((0, randombytes_1.default)(6).toString('hex'), 16));
        }
...
exports.TransactionV2 = TransactionV2;
exports.default = TransactionV2;
