...
function deriveChecksumBits(entropyBuffer) {
    ...
    const CS = ENT / 32;
    const hash = (0, create_hash_1.default)('sha256')
...
class Bip39 {
    mnemonicToSeedSync(mnemonic, password) {
        const mnemonicBuffer = buffer_1.Buffer.from((mnemonic || '').normalize('NFKD'), 'utf8');
        const saltBuffer = buffer_1.Buffer.from(salt((password || '').normalize('NFKD')), 'utf8');
