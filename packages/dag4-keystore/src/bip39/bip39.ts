...
/**
 * Default wordlist for BIP39 mnemonic generation.
 */
...
/**
 * Error message for invalid mnemonic.
 */
const INVALID_MNEMONIC = 'Invalid mnemonic';

/**
 * Error message for invalid entropy.
 */
const INVALID_ENTROPY = 'Invalid entropy';

/**
 * Error message for invalid checksum.
 */
const INVALID_CHECKSUM = 'Invalid mnemonic checksum';

/**
 * Error message for missing wordlist.
 */
...
/**
 * Derives the checksum bits from an entropy buffer.
 * @param entropyBuffer - The entropy buffer
 * @returns The checksum bits as a binary string
 */
...
/**
 * Creates a salt for PBKDF2 from a password.
...
/**
 * A class implementing BIP39 mnemonic code generation and validation.
 * Provides methods for generating, validating, and converting mnemonics.
 */
class Bip39 {

    /**
     * Synchronously converts a mnemonic to a seed.
    ...
    /**
     * Asynchronously converts a mnemonic to a seed.
     * @param mnemonic - The mnemonic phrase
     * @param password - An optional password
     * @returns A promise that resolves to the seed
     */
     ...
     * @param mnemonic - The mnemonic phrase
     * @param wordlist - An optional wordlist
     * @returns The entropy as a hexadecimal string
     ...
     * @param entropy - The entropy as a buffer or hex string
     * @param wordlist - An optional wordlist
     * @returns The mnemonic phrase
     * @throws Error if the entropy is invalid
     */
     ...
     * @param strength - The entropy strength in bits (default: 128)
     * @param rng - An optional random number generator
     * @param wordlist - An optional wordlist
     * @returns The generated mnemonic phrase
     * @throws Error if the strength is invalid
     */
